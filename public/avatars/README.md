...
`aimauta-teacher-v1.glb` is derived from `avatars/mpfb.glb` in
...
The versioned public filename is immutable. The web application serves avatar
assets with a one-year cache lifetime; changing the asset requires a new
versioned filename.
